...
We evaluated all models on the 20% held-out test set from the SMOTE-balanced and scaled data.
The table below summarizes overall accuracy, Cohen's Kappa, and balanced accuracy for each model.
...
![](images/ranger.png){width="300"} 
![](images/ranger_top30.png){width="300"}
...
one paragraph why removing outliers does not improve?