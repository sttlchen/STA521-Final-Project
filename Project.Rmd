...
# Plot bar charts (histogram for categorical variables)
ggplot(nepal_char_long, aes(x = category)) +
  ...
  labs(
    title = "Distribution of Character Variables in Nepal Dataset",
    x = "Category",
    y = "Count"
  )
```
